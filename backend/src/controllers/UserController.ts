          ...
          mailer.sendMail(
            {
              from: "admin@test.com",
              to: postData.email,
              subject: "Email Confirmation React Chat Tutorial",
              html: `In order to confirm your mail, go to <a href="http://localhost:3000/signup/verify?hash=${obj.confirm_hash}"> this link </a>`,
            },
